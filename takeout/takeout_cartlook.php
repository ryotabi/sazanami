...
<div class="wrapper">
    ...
    <main class="main-img">
        <div class="main-img-wrap">
            <div class="breadcrumb-area breadcrumb-style-3  ptb-100 bg-cartlook">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="toform-btn cartlook_btn"><input type="submit" value="数量変更"></div>
                    <div class="toform-btn cartlook_btn"><input type="submit" value="削除"></div>
                    <div class="toform-btn cartlook_btn"><a href="takeout_form.html">購入</a></div>
                    </form>
                </div>
            </div>
        </div>
